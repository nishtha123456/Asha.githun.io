    ...
    <Box className="section1" id="section1id">
        ...
        <Box className="section3">
            <div className="s3con">
                ...
                <p className="section2P1" id="section2P1ID">    Stand out and get hired faster with our collection of free professional cover letter templates expertly-designed to land you the perfect position </p>
            </div>
